    ...
    <main class="max-w-9/12 mx-auto grid grid-cols-2 items-center gap-20 min-h-screen">
        <div class="flex flex-col justify-center">
            ...
            <div class="flex gap-5">
                <button class="mt-16 w-max bg-[#68ac99] hover:bg-[#8592bc] px-10 py-4 rounded-2xl font-[inter] font-semibold text-lg text-[#09100d] cursor-pointer transition-all">
                    Create Resume
                </button>
                <button class="mt-16 w-max bg-[#E2EAEF] hover:bg-[#ACC0D1] px-10 py-4 rounded-2xl font-[inter] font-normal text-lg text-[#09100d] cursor-pointer transition-all">
