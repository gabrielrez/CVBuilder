<div class="step hidden">
    ...
    <div class="mt-6">
        <div class="w-full flex items-baseline gap-6">
            <div class="w-full">
                ...
                <input type="email" name="country" placeholder="United States" class="border-2 border-[#E2EAEF] px-2 py-2.5 w-full rounded-xl mt-2">
            </div>
            <div class="w-full">
                <label for="address">Address:</label>
                <input type="email" name="address" placeholder="123 Main Street, Apt. 4B" class="border-2 border-[#E2EAEF] px-2 py-2.5 w-full rounded-xl mt-2">
            </div>
            <div class="w-full">
                <label for="city">City:</label>
                <input type="text" name="city" placeholder="New York" class="border-2 border-[#E2EAEF] px-2 py-2.5 w-full rounded-xl mt-2">
            </div>
        </div>
    </div>
    <div class="flex justify-between items-baseline gap-5">
        ...
        <a class="next my-12 w-max bg-[#68ac99] px-10 py-3 rounded-2xl font-[inter] font-semibold text-lg text-[#09100d] cursor-pointer transition-all bg-[linear-gradient(to_right,#68ac99,#68ac99)] hover:bg-[linear-gradient(to_right,#68ac99,#8592bc)]">Next<i class="fa-solid fa-arrow-right ml-3"></i></a>
    </div>
</div>